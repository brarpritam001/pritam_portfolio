...
const texts = useMemo(() => [
    ...
    "Crafting Clean Code & Intuitive Interfaces",
    "Frontend Specialist with a User-Centric Focus",
    "Building Scalable, Seamless Digital Solutions",
    "Expert in UX/UI Design & Frontend Development",
], []);
